...
//        }
//    } else if (test == 2) {
//        float s[18] = {0.05, 54.2, 233.6, 322.4, 490.6, 583.8, 73.8, 50.2, 14.2, 7.4, 5.1, 3.2, 2.8, 1.4, 0.5, 0.01, 0.07};
//        float num = s[0];
//        [tableData addObject:@(num)];
//        for (int i = 1; i < 18; i++) {
//            num = s[i];
